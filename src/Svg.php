...
class Svg extends Xml
{
    ...
    public static function createSvg(
        ...
        $height = null,
        string $viewBox = null,
        PreserveAspectRatio $preserve = null
    ): self {
        self::initialize();
    ...
    public function mask(
        ...
        float $width = null,
        float $height = null,
        Units $maskUnits = null,
        Units $maskContentUnits = null
    ): self {
    ...
    public function addTranslate(float $x, float $y = null): self
    {
        return $this->setTransform(
            'translate',
            static::$formatter->format($x),
            static::$formatter->format($y)
        );
    }
    ...
    public function setD(Path $d = null): self
    {
        $this->attributes->setComplex(
            ...
            ' ',
            false,
            $d->toSvg(static::$formatter, static::$degreesFormatter)
        );
        return $this;
    }
    ...
    private static function degrees($angle)
    {
        if ($angle instanceof Angle) {
            $angle = $angle->getDegrees();
        }
        return static::$degreesFormatter->format($angle);
    }
